          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                - Reduce the use of call centers<br></br>- Provide 24/7
                Availability <br></br>- simplify customer service.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                - Step by step form completion<br></br>- Provide video and
                visual assistance <br></br>- Hosting of PDF's and documents
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">
                Imersive experiences
              </h4>
              <p className="text-gray-600 text-center">
                - Interactive learning<br></br>- Enhanced accessibility{" "}
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                - Increased engagement<br></br>- Brand Awareness
                <br></br>- Sales and conversions
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                - Customer Retention<br></br>- Private spaces <br></br>- Data
                Collection
              </p>
            </div>
          </div>
